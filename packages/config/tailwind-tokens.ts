 ...
 *
 * IMPORTANT: colour values here are FALLBACKS ONLY (used when no organisation
 ...
 * (packages/database) so each organisation's theme is applied automatically.
 * Never import a hardcoded hex colour directly into a component — read
 * the CSS variable instead (see apps/*/app/globals.css).
 */
export const baseTokens = {
  colors: {
    primary: '#16A34A', // Kewalram-default green; overridden per organisation
    secondary: '#0F172A',
    accent: '#22C55E',
    success: '#16A34A',
    warning: '#F59E0B',
