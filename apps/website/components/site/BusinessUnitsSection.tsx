...
const UNITS = [
  { name: 'Automotive', href: '/businesses/automotive', icon: '🚗' },
  { name: 'Agriculture', href: '/businesses/agriculture', icon: '🌾' },
  { name: 'Manufacturing', href: '/businesses/manufacturing', icon: '🏭' },
  { name: 'Food', href: '/businesses/food', icon: '🏢' },
  { name: 'Logistics', href: '/businesses/logistics', icon: '🚚' },
  { name: 'Healthcare', href: '/businesses/healthcare', icon: '🛒' },
];
