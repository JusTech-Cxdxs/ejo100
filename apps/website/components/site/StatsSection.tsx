...
const STATS: Stat[] = [
  { labelKey: 'stats.years', value: 150, suffix: '+', icon: <AwardIcon /> },
  { labelKey: 'stats.divisions', value: 20, suffix: '+', icon: <BuildingIcon /> },
  { labelKey: 'stats.employees', value: 10000, suffix: '+', icon: <UsersIcon /> },
  { labelKey: 'stats.countries', value: 50, suffix: '+', icon: <GlobeIcon /> },
];
