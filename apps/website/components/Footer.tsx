...
// Upload up to three files to public/images/footer-badges/ with these
// exact names to populate the badge row — see README_CHANGES.md.
const BADGES = [
  { src: '/images/footer-badges/footer-badge-1.png', alt: 'Certification badge 1' },
  { src: '/images/footer-badges/footer-badge-2.png', alt: 'Certification badge 2' },
  { src: '/images/footer-badges/footer-badge-3.png', alt: 'Certification badge 3' },
];

const QUICK_LINKS: [TranslationKey, string][] = [
  ['nav.about', '/about'],
...
const BUSINESS_LINKS: [TranslationKey, string][] = [
  ['business.automotive', '/businesses/automotive'],
  ['business.agriculture', '/businesses/agriculture'],
  ['business.manufacturing', '/businesses/manufacturing'],
  ['business.food', '/businesses/food'],
  ['business.logistics', '/businesses/logistics'],
  ['business.healthcare', '/businesses/healthcare'],
];
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-6">
        ...
        <div className="md:col-span-2">
          ...
          <div className="mt-5 flex items-center justify-start gap-4">
            {BADGES.map((badge) => (
              <FooterBadge key={badge.src} src={badge.src} alt={badge.alt} />
            ))}
          </div>
        ...
        <FooterColumn title={t('footer.ourBusinesses')} links={BUSINESS_LINKS} />
